...
import io.github.jhipster.application.JhipsterGradleApp;
...
@SpringBootTest(classes = JhipsterGradleApp.class)
public class RegionResourceIntTest {
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getProvinceName()).isEqualTo(DEFAULT_PROVINCE_NAME);
    }
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getProvinceName()).isEqualTo(UPDATED_PROVINCE_NAME);
    }
