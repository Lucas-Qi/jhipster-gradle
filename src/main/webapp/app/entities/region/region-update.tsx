    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterGradleApp.region.home.createOrEditLabel">Create or edit a Region</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : regionEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="provinceNameLabel" for="provinceName">
                    Province Name
                  </Label>
                  <AvField id="region-provinceName" type="text" name="provinceName" />
                </AvGroup>
